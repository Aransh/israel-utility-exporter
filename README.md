...
Requires `DOCKERHUB_USERNAME` and `DOCKERHUB_TOKEN` repository secrets (an
[access token](https://hub.docker.com/settings/security), not your Docker Hub
password) — Docker Hub has no OIDC trusted-publishing equivalent to npm's.
